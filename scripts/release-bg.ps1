# Final release build (exe + NSIS + MSI) with MSVC env; logs to %TEMP%\ktl-release.log
...
& npx tauri build 2>&1 | Out-File -FilePath $env:TEMP\ktl-release.log -Encoding utf8
