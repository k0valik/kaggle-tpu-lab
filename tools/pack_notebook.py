...
def main():
    ...
    cells.append(cell("markdown", "### The serving script\nThe next cell writes the serving script (the same one `launch.py` pushes; the source and docs are in the [kaggle-tpu-lab repo](https://github.com/k0valik/kaggle-tpu-lab)).\n"))
